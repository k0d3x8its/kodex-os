...
<img alt="CI" src="https://github.com/k0d3x8its/kodex-os/actions/workflows/ci.yml/badge.svg"?branch=main>
...
1. Install [Obsidian](https://obsidian.md) and create a new vault called `Kodex Vault`
2. Create the two top-level directories: `raw/` and `wiki/`
3. Inside `raw/`, create `assets/` and a folder for your active memo book(s) (e.g. `Field-Logs/FL-vol-001/` and/or `Field-Research/FR-vol-001/`)
